...
namespace SchemeServeTest.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LastInspection", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LastInspection_Providers_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LastInspection_ProviderId",
                table: "LastInspection",
                column: "ProviderId",
                unique: true);
